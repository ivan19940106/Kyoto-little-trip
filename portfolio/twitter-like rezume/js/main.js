    ...
    var vm = new Vue({
        ...
        data: {
            ...
            workData: [
                ...
                {title: '資策會團體專題：台北散步。', desc: '在這個Google搜尋結果如汪洋般無邊無際的世界裡，台北散步將國外free walking tour的體驗由線下搬至線上。不需要真人導遊或事先規劃，打開網頁即可跟著路線散步。兩小時實地走訪台北核心，迅速掌握台北城市的方向感、了解歷史脈絡。', references: [{item: '台北散步概述PPT', url: 'https://drive.google.com/file/d/1_8aQqua9kFKWUw03gdYDMb5xWWrYBgrh/view?usp=sharing'}, {item: '台北散步系統分析文件', url: 'https://drive.google.com/drive/folders/1Fs-ntT7Q91tL3ezh2Md9v72C0IIeIN9U?usp=sharing'}], hashtags: ['project', 'RWD', 'jQuery', 'AJAX', 'Google Map API', 'Canvas API', 'PHP', 'MySQL'], url: 'http://140.115.236.71/demo-projects/DD105/DD105G2/', imgPath: './image/work cover/taipei sanpo.gif'},
                ...
                {title: '75% 消毒酒精計算機', desc: '還可以換成生命之水、85度高粱酒調製喲！還好消毒酒精是用體積百分濃度，而不是用莫耳濃度計算！', hashtags: ['CSS3', 'Vue.js', 'smoke.js'], url: 'http://ivan19940106.github.io/Kyoto-little-trip/portfolio/alcohol/index.html', imgPath: './image/work cover/alcohol.gif'},
                ...
                {title: 'Atelier Koco. Official Website', desc: '製琴工作室 Atelier Koco. 官方網站，首頁產品區為我製作的第一把手工吉他唷！', references: [{item: 'Atelier Koco. intro. PPT', url: 'https://drive.google.com/file/d/19HN6qpSx2hjx3mBEiX4Ax3LAwVEY1z-r/view?usp=sharing'}], hashtags: ['project', 'RWD', 'tone.js', 'Chart.js'], url: 'http://ivan19940106.github.io/Kyoto-little-trip/portfolio/atelier%20koco./index.html', imgPath: './image/work cover/atelier koco..png'},
